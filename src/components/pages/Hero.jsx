    ...
    <div id="main" className="relative w-full h-screen overflow-hidden">
      ...
      <div className="w-full h-full absolute top-0 left-0 bg-white/50">
        <div className="max-w-[700px] m-auto h-full w-full flex flex-col justify-center items-center">
          ...
          <h1 className="title text-center sm:text-5xl text-4xl font-bold text-gray-800">
            I'm Diego Hernández García
          </h1>
          <h2 className="title uppercase text-center flex sm:text-3xl text-[1.4rem] pt-4 text-gray-800">
            I'm
            <TypeAnimation
              sequence={[
